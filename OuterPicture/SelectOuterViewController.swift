//
//  SelectOuterViewController.swift
//  OuterPicture
//
...
class SelectOuterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate
{
    var items = [UIImage]()
    ...
    override func viewDidLoad()
    {
        ...
        let rootPath = NSHomeDirectory() + "/Documents/Outer"
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        appDelegate?.outerImg = self.items[indexPath.row]
